...
hold on
grid on
plot([3:100],erreurf1,'black')
scatter([3:100],differenceBaryf1,'blue','LineWidth',1.5)
scatter([3:100],differencelagrangef1,'red','*')
set(gca,'yscale','log');
ylim([10^(-16) 10^0]);
xlim([3,100])
...
hold on
grid on
plot([3:100],erreurf2,'black')
scatter([3:100],differenceBaryf2,'blue','LineWidth',1.5)
scatter([3:100],differencelagrangef2,'red','*')
set(gca,'yscale','log');
ylim([10^(-16) 10^0]);
xlim([3,100])
...
for n = [3:100] ;
    % on va construire les n+1 points de chebyshev
    xcheby = [];
    for j = [1 : n+1];
...
hold on
grid on
plot([3:100],erreurf12,'black')
scatter([3:100],differenceBaryf12,'blue','LineWidth',1.5)
scatter([3:100],differencelagrangef12,'red','*')
set(gca,'yscale','log');
ylim([10^(-16) 10^0]);
xlim([3,100])
...
hold on
grid on
plot([3:100],erreurf22,'black')
scatter([3:100],differenceBaryf22,'blue','LineWidth',1.5)
scatter([3:100],differencelagrangef22,'red','*')
set(gca,'yscale','log');
ylim([10^(-14) 10^0]);
xlim([3,100])
